...
public class DoMath {
	...
	public static void main(String[] args) {
		System.out.println(Calculate.square(294));
		...
		System.out.println(Calculate.isPrime(13679));
		System.out.println(Calculate.gcf(234,24642));
		System.out.println(Calculate.sqrt(564));
